...
export const AUTH0_DOMAIN = 'auth.confidence.dev';
...
export const PLUGINS_REPO_URL = 'https://github.com/spotify/confidence-ai-plugins/tree/main';
export const SKILLS_BASE_URL =
  'https://raw.githubusercontent.com/spotify/confidence-ai-plugins/main/skills';

export const TELEMETRY_KEY_URL = 'https://onboarding.confidence.dev/v1/agentTelemetryKey:acquire';
